...
// The standard event emitter needs a native implementation and can't be
// run during tests
//
// Here we mock it as a standarad EventEmitter
//
// See https://stackoverflow.com/a/48595294
...
describe('authentication flow', () => {
  ...
  it('should return user profile information from id token', async () => {
    const mockGetIdToken = require('react-native').NativeModules.OktaSdkBridge
      .getIdToken
